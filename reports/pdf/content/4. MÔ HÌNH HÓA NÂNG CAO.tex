...
Sau khi huấn luyện, chúng tôi sử dụng thuộc tính feature\_importances\_ để xác định mức độ đóng góp của từng đặc trưng vào mô hình.
\begin{figure}[H]
    \centering
...
\begin{itemize}
    ...
    \item[-] RMSE của Baseline (Lỉnear Regression): \$58,137.54
