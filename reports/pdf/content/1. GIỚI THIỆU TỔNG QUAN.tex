...
Bất động sản từ lâu đã là một trong những kênh đầu tư và tài sản quan trọng với hầu hết mọi người. Tuy nhiên, việc xác định giá trị thực sự của một căn nhà không phải lúc nào cũng đơn giản - giá nhà phụ thuộc vào rất nhiều yếu tố khác nhau, từ diện tích và chất lượng xây dựng cho đến vị trí, tiện nghi xung quanh, và cả thời điểm giao dịch. Có thể thấy, việc định giá một căn nhà là một việc rất khó khăn với những người thiếu kinh nghiệm.\medskip

Đó cũng là lý do mà nhóm đã chọn đề tài này. Bằng cách ứng dụng các kỹ thuật \texttt{Data Mining} và \texttt{Machine Learning}, nhóm kỳ vọng có thể xây dựng một mô hình dự đoán giá nhà dựa trên dữ liệu thực tế.\medskip

Source code của dự án có thể tìm thấy ở \href{https://github.com/nxhhoang/CO3029-Data-mining-house-prices-advanced-regression}{Link}.
...
Tập dữ liệu được sử dụng đến từ cuộc thi "\textit{House Prices: Advanced Regression Techniques}" trên \texttt{Kaggle}, tập trung vào thị trường bất động sản tại thành phố \texttt{Ames}, \texttt{Iowa}. Tập dữ liệu bao gồm 2919 mẫu, gồm 1460 mẫu trong tập huấn luyện và 1459 mẫu trong tập kiểm tra, mỗi mẫu tương ứng với một căn nhà tại thành phố \texttt{Ames}, \texttt{Iowa}, Hoa Kỳ, được giao dịch trong giai đoạn 2006–2010. Điểm đặc biệt của tập dữ liệu này là nó có tới 79 thuộc tính đầu vào, bao gồm cả biến định lượng lẫn định tính, phản ánh gần như mọi khía cạnh của một căn nhà. Một số thuộc tính quan trọng:
\begin{itemize}
