...
Đó cũng là lý do mà nhóm đã chọn đề tài này. Bằng cách ứng dụng các kỹ thuật \texttt{Data Mining} và \texttt{Machine Learning}, nhóm kỳ vọng có thể xây dựng một mô hình dự đoán giá nhà dựa trên dữ liệu thực tế.
